LANGUAGE_NAME := tree-sitter-mgs
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-mgs
VERSION := 0.1.0
DESCRIPTION := Mgs grammar for tree-sitter
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/mgs '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/mgs
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/mgs
